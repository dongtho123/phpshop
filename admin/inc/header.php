    ...
    <li class="nav-item">
        ...
        <div id="collapseStatistic" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="productadd.php">Add Products</a>
                         <a class="collapse-item" href="productedit.php">Edit Products</a>
                        <a class="collapse-item" href="productlist.php">List Products</a>
            </div>
        </div>
    </li>
